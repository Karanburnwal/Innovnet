  ...
  return (
    <div className={styles.top}>
      <div className={styles.topLeft}>
        <i className={styles.topIcon + " fab fa-facebook-square"}></i>
        <i className={styles.topIcon + " fab fa-twitter-square"}></i>
        <i className={styles.topIcon + " fab fa-pinterest-square"}></i>
        <i className={styles.topIcon + " fab fa-instagram-square"}></i>
      </div>
      <div className={styles.topCenter}>
        <ul className={styles.centerList}>
          <li className={styles.centerListItem}>
            <Link to="/">Home</Link>
          </li>
          <li className={styles.centerListItem}>
          ...
          <li className={styles.centerListItem} onClick={handleLogout}>
            {user && "LOGOUT"}
          </li>
        </ul>
      </div>
      <div className={styles.topRight}>
        {user ? (
          <>
            <Link to="/messenger">
              <i className={styles.messege + " fab fa-facebook-messenger"}></i>
            </Link>
            <Link to="/settings">
              <img
